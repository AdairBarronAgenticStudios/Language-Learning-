...
// Removed import for dictionary API
...
// --- Style for Modal --- (keep this for other modals if needed)
const modalStyle = {
  position: 'absolute',
  top: '50%',
  left: '50%',
...
const RoleplayGame: React.FC = () => {
  ...
  // Modified renderClickableText to just display text without click handlers
